...
export default async (req, res) => {
    const directoryPath = path.join('./sources/logs/graphql');
    ...
    if (method === 'POST') {
        ...
        await fsPromise.writeFile(`./sources/logs/graphql/${Date.now().toString()}.json`, JSON.stringify(newLogItem, null, 4));
